...
typedef int (WINAPI *PFNSETMAPFLAG)( char *szFlagName, int iFlagValue, int iFlagTarget );
PFNSETMAPFLAG p_SetMapFlag = NULL;
typedef int (WINAPI *PFNGETMAPFLAG)( char *szFlagName, int iFlagTarget );
PFNGETMAPFLAG p_GetMapFlag = NULL;
typedef int (WINAPI *PFNDELETEMAPFLAG)( char *szFlagName );
